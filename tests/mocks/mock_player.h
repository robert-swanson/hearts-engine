...
public:
    ...
    MOCK_METHOD(void, notifyStartGame, (std::vector<PlayerID> playerOrder, const std::string& gameId, const std::string& resultsRelDir, (const std::vector<std::string>&) playerFullIds));
    ...
    MOCK_METHOD(void, notifyMove, (PlayerID playerID, Card card, bool autoMoved));
